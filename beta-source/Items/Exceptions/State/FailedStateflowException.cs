...
{
    ///  <summary>
    ///  An <see cref="Exception">exception</see> of an <see langword="failed"/> state of an instance.
    /// </summary>
    /// 
    ///  <remarks>
    ...
    [Serializable]
    public sealed class FailedStateflowException : Exception
    {
        ///  <summary>
        ...
        /// </summary>
        /// 
        public FailedStateflowException() { }
        ...
        /// </param>
        /// 
        public FailedStateflowException(int data) : base(String.Format("Custom exception with data {0}.", data))
        {
            this.data = data;
        }
        ...
        /// </param>
        /// 
        public FailedStateflowException(int data, string message) : base(String.Format("Custom exception with data {0}.", data))
        {
            this.data = data;
        ...
        /// </param>
        /// 
        public FailedStateflowException(int data, string message, Exception inner) : base(String.Format("Custom exception with data {0}.", data))
        {
            this.data = data;
            this.message = message;
            this.inner = inner;
        ...
        /// </param>
        /// 
        public FailedStateflowException(string message) : base(message)
        {
            this.message = message;
        }
        ...
        /// </param>
        /// 
        public FailedStateflowException(string message, Exception inner) : base(message)
        {   
            this.message = message;
            this.inner = inner;
        }
        ...
        /// </exception>
        /// 
        private FailedStateflowException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
